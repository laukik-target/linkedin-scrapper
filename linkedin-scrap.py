...
target_company_link = "https://www.linkedin.com/company/cisco/"

# Filters
HEADLINE_FILTERS = ["Director"]
COUNTRY_FILTERS = ["India", "Canada"]
...
class LinkedIn:
    ...
    def listProfiles(self, company_id, page_no, need_count=False):
        ...
        profiles = elements[0].get('elements')
        all_profile_links = []
        ...
        for profile in profiles:
            ...
            if (not HEADLINE_FILTERS or any(keyword in headline for keyword in HEADLINE_FILTERS)) and (not COUNTRY_FILTERS or any(keyword in country for keyword in COUNTRY_FILTERS)):
...
if __name__ == "__main__":
    ...
    if login_state:
        ...
        if company_id is not None:
            print("Trying to fetch all company member profiles...")
